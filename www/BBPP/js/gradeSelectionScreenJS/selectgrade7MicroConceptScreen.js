Game.selectgrade7MicroConceptScreen=function(){

};

Game.selectgrade7MicroConceptScreen.prototype={
	...
	create:function(game){		
		...
		nativeApp.screenViewStringPass("Practice_topic_selection_screen","grade7MicroConceptScreen");

		this.game = game;

		_this = this;
		selectgrade7MicroConcept = true;
		selectgrade2MicroConcept = false;
		selectgrade3MicroConcept = false;
		selectgrade4MicroConcept = false;
		selectgrade5MicroConcept = false;

		if(grade7NumberSystemsSelected)
		{
			this.state.start('grade7NumberSystems',true,false);
		}
		else if(grade7AlgebraSelected)
		{
			this.state.start('grade7Algebra',true,false);
		}
		else if(grade7RatioandProportionSelected)
		{
			//this.state.start('grade6RatioandProportion',true,false);
		}
		else if(grade7GeometrySelected)
		{
			this.state.start('grade7Geometry',true,false);
		}
		else if(grade7DecimalsSelected)
		{
			this.state.start('grade7Decimals',true,false);
		}
		else
		{
			...
			this.gradeBackBtn.events.onInputDown.add(function(){
				...
				selectgrade7MicroConcept = false;
	...
	{			
		...
		{
			this.state.start('gradeNumberSystems',true,false);
		}			
	},
