Game.AL_ADD_G7level1 = function () { };


Game.AL_ADD_G7level1.prototype =
{
    init: function (param, score) {
        ...
        _this.Ask_Question1 = _this.createAudio("AL_ADD_G7_a1");
        _this.Ask_Question2 = _this.createAudio("AL_ADD_G7_a2");

        //edited for baseurl online apk
        telInitializerbbpp.gameIdInit("AL_ADD_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/AL-ADD-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    AskingQuestion: function () {
        ...
        _this.yellowbox1.scale.setTo((_this.tempText.getBounds().width) / (_this.yellowbox1.getBounds().width), 1);
        string += ' + ';
        string1 = '( ';
        if (_this.order2[0] == 1) {
            if (_this.mSquare2 == 1)
        ...
        _this.yellowbox2 = _this.add.image((_this.tempText.getBounds().width) + 30, 14, 'yellow box');
        _this.tempText.destroy();
        _this.tempText = _this.add.text(0, 0, string1);
        _this.tempText.visible = false;
        _this.yellowbox2.scale.setTo((_this.tempText.getBounds().width) / (_this.yellowbox2.getBounds().width), 1);
    ...
    tickEvaluation: function (target) {
        ...
        console.log(a);
        if (a[0] == _this.mSquare1 && a[1] == _this.mLinear1 && a[2] == _this.mConstant1) {
    ...
    tickSecondEvaluation: function (target) {
        {
            ...
            if (a[0] == _this.mSquare2 && a[1] == _this.mLinear2 && a[2] == _this.mConstant2) {
                target.events.onInputDown.removeAll();
                console.log("hiiiiii")
                ...
                for (let j = 0; j < Math.abs(_this.mSquare2); j++) {
                    console.log("re arrngeee")
                    _this.limit2 += 6;
                    let square;
                    if (_this.mSquare2 < 0)
    ...
    mergeOperation: function () {
        ...
        if (_this.numberOfQuestions == 0) {
            ...
            _this.handTween.to({ x: 57, y: 290 }, 2000, 'Linear', true, 0);
        ...
        _this.symbol_2.events.onInputDown.add(_this.zeroPairSymbolClicked);
    },

    zeroPairSymbolClicked: function () {
        _this.clickSound.play();
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/AL-ADD-G7/" + _this.languageSelected + "/AL_ADD_G7_d1.mp3");
        _this.demoAudio1.appendChild(_this.demoAudio1src);

        //*  Zero pair button will zero pairing -ve and +ve in  like terms .
        _this.demoAudio2 = document.createElement('audio');
        _this.demoAudio2src = document.createElement('source');
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/AL-ADD-G7/" + _this.languageSelected + "/AL_ADD_G7_d2.mp3");
        _this.demoAudio2.appendChild(_this.demoAudio2src);

        // QUESTION AUDIOS
        //*  Find the addition of the algebraic equations
        _this.q1Sound = document.createElement('audio');
        _this.q1Soundsrc = document.createElement('source');
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/AL-ADD-G7/" +
            _this.languageSelected + "/AL_ADD_G7_a1.mp3");
        _this.q1Sound.appendChild(_this.q1Soundsrc);

        //* Model the equation using algebraic tiles
        _this.q2Sound = document.createElement('audio');
        _this.q2Soundsrc = document.createElement('source');
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/AL-ADD-G7/" +
            _this.languageSelected + "/AL_ADD_G7_a2.mp3");
        _this.q2Sound.appendChild(_this.q2Soundsrc);

        //* enter the answer 
        _this.q3Sound = document.createElement('audio');
        _this.q3Soundsrc = document.createElement('source');
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/AL-ADD-G7/" +
            _this.languageSelected + "/AL_ADD_G7_a3.mp3");
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('aladdg7');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/AL-ADD-G7.mp4");
        ...
        {
            _this.demoAudio2Timer = setTimeout(function ()    //* demo audio2 js timer to play demo audio2 after 37 seconds.
            {
