Game.INT_ML3_G7level1 = function () { };


Game.INT_ML3_G7level1.prototype =
{
    init: function (param, score) {
        ...
        telInitializerbbpp.gameIdInit("NS_INT_ML_3_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML3-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/INT-ML3-G7/" + _this.languageSelected + "/INT_ML1_G7_d1.mp3");
        ...
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/INT-ML3-G7/" + _this.languageSelected + "/INT_ML1_G7_d2.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML3-G7/" +
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML3-G7/" +
        ...
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML3-G7/" +
        ...
        _this.q4Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML3-G7/" +
    ...
    dA3: function () {
        ...
        _this.q4Timer = setTimeout(function ()    //* q2 js timer to play q2 after 30 seconds.
        {
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('ML3_1');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/MLP-03-G7.mp4");
        ...
        _this.q2Timer = setTimeout(function ()    //* q1 js timer to play q1 after 14 seconds.
        {
