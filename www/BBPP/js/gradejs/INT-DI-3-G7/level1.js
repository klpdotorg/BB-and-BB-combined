Game.INT_DI3_G7level1 = function () { };


Game.INT_DI3_G7level1.prototype =
{
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-3-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    StoreArrayValues: function () {
        ...
        for (i = 0; i < 6; i++) {
            ...
            dividend[i] = x;
            divisor[i] = y;
            valuesCombinations[i] = (-x) / (-y); //x is positive
    ...
    showInitialScreen: function () {
        ...
        //plus sign
        // _this.plus = _this.add.sprite(35, 10 + 5, 'plus')
        // _this.blueBox1.addChild(_this.plus)
        // minus = _this.add.sprite(22, 18, 'plusMinusS');
        // _this.plus.addChild(minus)
        // _this.plus.inputEnabled = true;
        // _this.plus.events.onInputDown.add(_this.minusDrop, _this)
        ...
        if (dividend[_this.count1] > 9)
            _this.text2 = _this.add.text(36, 30, '-' + dividend[_this.count1])//dividend + //no braces for - sign*
        else
            _this.text2 = _this.add.text(43, 30, '-' + dividend[_this.count1])//dividend +
        ...
        if (_this.part1 == true) {
            ...
            if (_this.getAnswer1()) {
                ...
                _this.time.events.add(500, () => {
                    ...
                    _this.plus.inputEnabled = false; ///changed plus to minus1
    ...
    divideCounters: function (target) {
        ...
        for (i = 0; i < divisor[_this.count1]; i++) {
            console.log('inside for of divide........')
        ...
        console.log('divide counters initial')
    ...
    showFinalPart: function () {
        ...
        if (dividend[_this.count1] > 9)
            _this.text2 = _this.add.text(36 - 5, 30, '-' + dividend[_this.count1]) ///changed into minus
        else
            _this.text2 = _this.add.text(43 - 5, 30, '-' + dividend[_this.count1]) ///changed into minus_this
        _this.applyingStyle(_this.text2)
        _this.questionBox.addChild(_this.text2)
        _this.text2.scale.setTo(1.2)
        _this.text2.fill = '#F0000';
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src",  window.baseUrl +"questionSounds/INT-DI-3-G7/" + _this.languageSelected + "/INT_DI1_d1.mp3");
        ...
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-3-G7/" + _this.languageSelected + "/INT_DI1_d2.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-3-G7/" +
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-3-G7/" +
        ...
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-3-G7/" +
        ...
        _this.q4Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-3-G7/" +
        ...
        _this.q5Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-3-G7/" +
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('INTDI3G7');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl+"assets/demoVideos/INT-DI-3-G7.mp4");
