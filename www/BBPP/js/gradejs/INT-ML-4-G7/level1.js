Game.INT_ML4_G7level1 = function () { };


Game.INT_ML4_G7level1.prototype =
{
    init: function (param, score) {
        ...
        telInitializerbbppbbpp.gameIdInit("NS_INT_ML_4_G7", gradeSelected);// first Tele call
    ...
    gameCreate: function (game) {
        ...
        _this.speakerbtn.events.onInputDown.add(function () {
            telInitializerbbppbbpp.tele_interactEvent("TOUCH", "speaker");
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML4-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    showInitialScreen: function () {
        ...
        if (multiplicand[_this.count1] > 9)
            _this.text2 = _this.add.text(44, 30, '-' + multiplicand[_this.count1])
        else
            _this.text2 = _this.add.text(52, 30, '-' + multiplicand[_this.count1])
        ...
        if (multiplier[_this.count1] > 9)
            ...
            _this.text4 = _this.add.text(153 - 2, 30, '(+' + multiplier[_this.count1] + ')')
    ...
    showFinalPart: function () {
        ...
        if (multiplier[_this.count1] > 9)
            ...
            _this.text4 = _this.add.text(153 - 11, 30, '(+' + multiplier[_this.count1] + ')')
        _this.applyingStyle(_this.text4)
        _this.questionBox.addChild(_this.text4)
        _this.text4.scale.setTo(1.2)
        _this.text4.fill = '#F0000';
    ...
    equalsSign: function () {
        ...
        _this.eqSign1.moveTo(605 + 5 - 3, 80 + 38 - 3);
        _this.eqSign1.lineTo(605 + 22 - 3, 80 + 38 - 3);

        _this.eqSign2 = _this.add.graphics();
        _this.eqSign2.lineStyle(4, 0xF0000);
        _this.eqSign2.moveTo(605 + 5 - 3, 80 + 48 - 3);
        _this.eqSign2.lineTo(605 + 22 - 3, 80 + 48 - 3);
    },
    ...
    correctAns: function () {
        ...
        if (_this.count1 < 5) {
            //edited for baseurl apk
            _this.noofAttempts++;
            telInitializerbbppbbpp.tele_saveAssessment(_this.questionid, "yes", _this.AnsTimerCount, _this.noofAttempts, _this.sceneCount);
            //..............
    ...
    shutdown: function () {
        _this.stopVoice();
        //RI.gotoEndPage();
        //telInitializerbbppbbpp.tele_end();
    },
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/INT-ML4-G7/" + _this.languageSelected + "/INT_ML1_G7_d1.mp3");
        ...
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/INT-ML4-G7/" + _this.languageSelected + "/INT_ML1_G7_d2.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML4-G7/" +
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML4-G7/" +
        ...
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML4-G7/" +
        ...
        _this.q4Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML4-G7/" +
    ...
    dA3: function () {
        ...
        _this.q3Timer = setTimeout(function ()    //* q2 js timer to play q2 after 5 seconds.
        {
        ...
        _this.q4Timer = setTimeout(function ()    //* q2 js timer to play q2 after 35 seconds.
        {
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('ML4_1');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/MLP-04-G7.mp4");
