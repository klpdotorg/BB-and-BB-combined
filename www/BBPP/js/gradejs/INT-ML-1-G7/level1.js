Game.INT_ML1_G7level1 = function () { };


Game.INT_ML1_G7level1.prototype =
{
    init: function (param, score) {
        ...
        telInitializerbbpp.gameIdInit("NS_INT_ML_1_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML1-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    equalsSign: function () {
        ...
        _this.eqSign1.moveTo(605 + 5 - 3 + 4, 80 + 38 - 3);
        _this.eqSign1.lineTo(605 + 22 - 3 + 4, 80 + 38 - 3);

        _this.eqSign2 = _this.add.graphics();
        _this.eqSign2.lineStyle(4, 0xF0000);
        _this.eqSign2.moveTo(605 + 5 - 3 + 4, 80 + 48 - 3);
        _this.eqSign2.lineTo(605 + 22 - 3 + 4, 80 + 48 - 3);
    },
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/INT-ML1-G7/" + _this.languageSelected + "/INT_ML1_G7_d1.mp3");
        ...
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/INT-ML1-G7/" + _this.languageSelected + "/INT_ML1_G7_d2.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML1-G7/" +
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML1-G7/" +
        ...
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML1-G7/" +
        ...
        _this.q4Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-ML1-G7/" +
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/MLP-01-G7.mp4");
