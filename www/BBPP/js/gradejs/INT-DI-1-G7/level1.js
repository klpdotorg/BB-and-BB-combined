Game.INT_DI1_G7level1 = function () { };


Game.INT_DI1_G7level1.prototype =
{
    init: function (param, score) {
        ...
        telInitializerbbpp.gameIdInit("NS_INT_DI_1_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-1-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    showInitialScreen: function () {
        ...
        if (divisor[_this.count1] > 9)
            _this.text4 = _this.add.text(144, 30, '(+' + divisor[_this.count1] + ')')
        else
            _this.text4 = _this.add.text(151, 30, '(+' + divisor[_this.count1] + ')')
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-1-G7/" + _this.languageSelected + "/INT_DI1_d1.mp3");
        ...
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-1-G7/" + _this.languageSelected + "/INT_DI1_d2.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-1-G7/" +
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-1-G7/" +
        ...
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-1-G7/" +
        ...
        _this.q4Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-1-G7/" +
        ...
        _this.q5Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-1-G7/" +
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('INTDI1G7');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/INT-DI-1-G7.mp4");
