Game.INT_DI2_G7level1 = function () { };


Game.INT_DI2_G7level1.prototype =
{
    init: function (param, score) {
        ...
        telInitializerbbpp.gameIdInit("NS_INT_DI_2_G7", gradeSelected);// first Tele call
    ...
    createAudio: function (src) {
        ...
        audiosrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-2-G7/" + _this.languageSelected + "/" + src + ".mp3");
    ...
    DemoVideo: function () {
        ...
        _this.demoAudio1src.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-2-G7/" + _this.languageSelected + "/INT_DI1_d1.mp3");
        ...
        _this.demoAudio2src.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-2-G7/" + _this.languageSelected + "/INT_DI1_d2.mp3");
        ...
        _this.q1Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-2-G7/" +
        ...
        _this.q2Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-2-G7/" +
        ...
        _this.q3Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-2-G7/" +
        ...
        _this.q4Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-2-G7/" +
        ...
        _this.q5Soundsrc.setAttribute("src", window.baseUrl + "questionSounds/INT-DI-2-G7/" +
            _this.languageSelected + "/INT_DI1_G7_a5.mp3");
        _this.q5Sound.appendChild(_this.q5Soundsrc);

        _this.video_playing = 0;
        _this.showDemoVideo();
        _this.skip = _this.add.image(870, 390, 'skipArrow');
    ...
    showDemoVideo: function () {
        ...
        _this.demoVideo_1 = _this.add.video('INTDI2G7');
        _this.demoVideo_1.play(false);
        _this.demoVideo_1.changeSource(window.baseUrl + "assets/demoVideos/INT-DI-2-G7.mp4");
