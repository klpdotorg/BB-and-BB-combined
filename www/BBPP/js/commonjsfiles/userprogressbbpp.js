...
Game.userprogressbbpp.prototype={
	...
	afterDataFetched:function(game){
    	...
    	// 	this.clickSound = this.add.audio('ClickSound');
        // 	this.clickSound.play();
    	// 	this.state.start('userprogress2bbpp',true,false,"NumberSense",this.responseData,this.responseData);
    	// },this);
    	...
    	// 	this.clickSound = this.add.audio('ClickSound');
        // 	this.clickSound.play();
    	// 	this.state.start('userprogress2bbpp',true,false,"Measurement",this.responseData,this.responseData);
    	// },this);
    	...
    	// 	this.clickSound = this.add.audio('ClickSound');
        // 	this.clickSound.play();
    	// 	this.state.start('userprogress2bbpp',true,false,"NumberOperation",this.responseData,this.responseData);
    	// },this);
