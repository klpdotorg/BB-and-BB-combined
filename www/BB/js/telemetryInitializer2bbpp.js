var telInitializer2bbpp = {
	...
	gameCorrectAns:function(game,object)
	{
		...
		this.screenCount++;
		telInitializer2bbpp.tele_saveAssessment2(this.questionId,"yes",this.seconds,this.numberOfAttempts,this.screenCount);
	...
	gameWrongAns:function(game,object)
	{
		this.numberOfAttempts++;
		this.screenCount++;
		telInitializer2bbpp.tele_saveAssessment2(this.questionId,"no",this.seconds,this.numberOfAttempts,this.screenCount);
