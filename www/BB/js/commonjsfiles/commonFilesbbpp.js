var commonNavBarbbpp = {
    ...
    addHint:function(game,hintparams)
    {
        ...
        if(hintparams!=null){
            commonNavBarbbpp.hint1 = hintparams[2];
            commonNavBarbbpp.hint2 = hintparams[3];
            commonNavBarbbpp.hint3 = hintparams[4];
        }
    ...
    */
    ...
    deductScore:function(game,value,flag,colorflag,hintparams)
    {
        ...
        //alert("mmmm"+commonNavBarbbpp.deductForHint);
